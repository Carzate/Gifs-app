  ...
  <div>
    <div class="px-6 pt-3 lg:pt-6 mb-4 bg-blue-50 dark:bg-slate-900 sticky top-0 z-50 rounded-lg">
      <form class="flex items-center mx-auto lg:w-1/2" @submit.prevent="clearAndSearch">   
          ...
          <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-blue-400 rounded-lg border border-blue-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-600 dark:bg-blue-400 dark:hover:bg-blue-600 dark:focus:ring-blue-600">
